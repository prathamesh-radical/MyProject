...
export default function UserEvents({ route, visible, handleClose }) {
            ...
            <Menu.Item
                ...
                title={
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <View style={{ position: 'relative', left: visible ? 70 : 60 }}>
                            <Icon
            ...
            {visible && (
                <View style={styles.menu_submenu}>
                    <Menu.Item
                        ...
                        title="All Events"
                        onPress={() => {
                            navigation.navigate("AllEvents", { panelType: "User" });
                    ...
                    {eventsData.map((event) => (
                        <Menu.Item
                            ...
                            onPress={() => {
                                navigation.navigate(
                                    "UserEventDetails", { eventId: event.event_id, eventName: event.event_name, }
                                );
                                handleClose("submenu", false);
                                handleClose("menu", false);
                            }}
